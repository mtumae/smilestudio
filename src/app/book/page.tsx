...
// Simplified to just keep consultation details
...
export default function AppointmentBooking() {
  ...
  const [type] = useState(DEFAULT_APPOINTMENT.name);
  ...
  const generateAvailableTimeSlots = (): void => {
    ...
    const slots: string[] = [];
    const duration = DEFAULT_APPOINTMENT.duration;
  ...
  const handleSubmit = async () => {
    ...
    const endDateTime = addMinutes(startDateTime, DEFAULT_APPOINTMENT.duration);
  ...
  const renderStepIndicator = () => (
    ...
    >
      {[
        ...
        { step: 2, label: "Schedule", icon: Clock3 }
              ...
              {currentStep === 2 && (
                ...
                >
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 mt-3">Choose a convenient date and time for your consultation</p>
                  </div>
                    ...
                    <div className="space-y-3 text-left">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {DEFAULT_APPOINTMENT.duration} minutes
                        </span>
                      </div>
                      <div className="flex justify-between">
